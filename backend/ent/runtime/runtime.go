...
func init() {
	...
	// redeemcodeDescSalePrice is the schema descriptor for sale_price field.
	redeemcodeDescSalePrice := redeemcodeFields[3].Descriptor()
	// redeemcode.DefaultSalePrice holds the default value on creation for the sale_price field.
	redeemcode.DefaultSalePrice = redeemcodeDescSalePrice.Default.(float64)
