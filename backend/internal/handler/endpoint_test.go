...
func TestNormalizeInboundEndpoint(t *testing.T) {
	tests := []struct {
		...
		{"/v1/images/generations/async", EndpointImagesGenerationsAsync},
		{"/v1/images/edits/async", EndpointImagesEditsAsync},
		{"/images/generations/async", EndpointImagesGenerationsAsync},
		{"/images/edits/async", EndpointImagesEditsAsync},
...
func TestDeriveUpstreamEndpoint(t *testing.T) {
	tests := []struct {
		...
		{"openai async image generations", EndpointImagesGenerationsAsync, "/v1/images/generations", service.PlatformOpenAI, EndpointImagesGenerations},
		{"openai async image edits", EndpointImagesEditsAsync, "/v1/images/edits", service.PlatformOpenAI, EndpointImagesEdits},
		{"grok async image generations", EndpointImagesGenerationsAsync, "/v1/images/generations", service.PlatformGrok, EndpointImagesGenerations},
		{"grok async image edits", EndpointImagesEditsAsync, "/v1/images/edits", service.PlatformGrok, EndpointImagesEdits},
