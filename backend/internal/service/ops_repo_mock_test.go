...
type opsRepoMock struct {
	...
	ListNodeMetricsFn             func(ctx context.Context, seenSince time.Time) ([]*OpsNodeMetrics, error)
...
func (m *opsRepoMock) ListNodeMetrics(ctx context.Context, seenSince time.Time) ([]*OpsNodeMetrics, error) {
	if m.ListNodeMetricsFn != nil {
		return m.ListNodeMetricsFn(ctx, seenSince)
	}
...
func (m *opsRepoMock) UpdateAlertEventWeComSent(ctx context.Context, eventID int64, weComSent bool) error {
	return nil
}
