...
describe('admin UsageTable request type', () => {
  it('renders async usage with the async label and badge color', () => {
    const wrapper = mount(UsageTable, {
      props: {
        data: [{ ...baseImageRow, request_type: 'async', stream: false }],
        loading: false,
        columns: [],
      },
      global: {
