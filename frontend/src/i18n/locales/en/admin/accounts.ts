export default {
    accounts: {
      ...
      columns: {
        ...
        upstreamBillingRate: 'Upstream information',
        weight: 'Weight',
      ...
      upstreamBilling: {
        ...
        rateDetails: 'Declared rate',
        rateValueDetails: 'Declared rate details: {value}',
        quotaDetails: 'Upstream quota',
        ...
        queryQuota: 'Query upstream quota',
        refreshQuota: 'Refresh upstream quota',
        notQueried: 'Not queried',
        queryingQuota: 'Querying...',
        unlimited: 'Unlimited',
        quotaFailed: 'Failed',
        quotaQueryFailed: 'Failed to query upstream quota',
        quotaError: 'Latest quota query failed: {message}',
        quotaValueDetails: 'Quota details: {value}',
        noQuotaData: 'No quota data',
        quotaProvider: 'Provider: {value}',
        quotaMode: 'Mode: {value}',
        quotaModeBalance: 'Balance',
        quotaModeQuota: 'Quota',
        quotaModeSubscription: 'Subscription',
        quotaModeRateLimits: 'Rate limits',
        quotaPlan: 'Plan: {value}',
        quotaRemaining: 'Remaining: {value}',
        quotaUsed: 'Used: {value}',
        quotaTotal: 'Total: {value}',
        quotaUnit: 'Unit: {value}',
        unknownUnit: 'Unknown',
        quotaExpiresAt: 'Expires: {value}',
        quotaWindows: 'Windows',
        quotaWindow: '{name}: used {used}, limit {limit}, remaining {remaining}, reset {reset}',
        quotaObservedAt: 'Observed: {value}',
        stale: 'Stale',
        unsupportedNotFound: 'Rate endpoint not found (404).',
        unsupportedMethod: 'Rate endpoint does not support this method (405).',
        unsupportedGeneric: 'No compatible rate endpoint found.',
        probeAuthFailed: 'Authentication failed ({status}).',
        probeRateLimited: 'Request rate-limited (429).',
        probeServerError: 'Upstream service error ({status}).',
        probeInvalidResponse: 'Invalid rate response format.',
        probeResponseTooLarge: 'Rate response too large.',
        probeResponseReadFailed: 'Failed to read rate response.',
        probeEmptyResponse: 'No rate response returned.',
        probeMissingApiKey: 'API key missing.',
        probeInvalidBaseUrl: 'Invalid Base URL.',
        probeProxyUnavailable: 'Proxy unavailable.',
        probeTransportUnavailable: 'Probe transport unavailable.',
        probeRequestBuildFailed: 'Could not build probe request.',
        probeRequestFailed: 'Could not connect to rate endpoint.',
        probeHttpError: 'HTTP {status}.',
        probeFailedReason: 'Rate probe failed.',
        probeErrorTitle: 'An error occurred:',
        probeErrorDetail: 'An error occurred during the probe at {time}: {reason}',
        ...
        hoursMinutesAgo: '{hours} hours {minutes} minutes',
        daysAgo: '{count} days',
        staleCacheNotice: 'This page shows a probe result from {age} ago. Refresh the page to see the latest server data.',
        staleProbeOverdueNotice: 'The last successful rate shown is from {age} ago. The automatic probe is overdue. Refresh the page first; if it is still unchanged, click the refresh button on the right to probe again.',
        manualProbeNotice: 'This page is showing the last successful rate from {age} ago. Click the refresh button on the right to probe again.',
        failedNoRateNotice: 'No rate is available to display. Click the refresh button on the right to retry.',
        ...
        batchStarted: 'Selected {count} accounts. Split into {total} batches; probing batch 1/{total}.',
        batchProgress: 'Completed batch {completed}/{total}; probing batch {next}/{total}.',
        ...
        quotaBatchStarted: 'Selected {count} accounts. Split into {total} batches; fetching balances for batch 1/{total}.',
        quotaBatchProgress: 'Completed batch {completed}/{total}; fetching balances for batch {next}/{total}.',
        quotaBatchCompleted: 'Fetched balances for {count} account(s)',
        quotaBatchPartial: 'Balance fetch partially completed: {success} succeeded, {failed} failed',
        historyTitle: 'Declared rate history',
        historyRange: 'History range',
        historyRangeDays: '{count} days',
        historyRetry: 'Retry',
        historyTruncated: 'Only the newest 500 detected changes are shown.',
        historyEmpty: 'No detected rate changes in this range.',
        historyRefreshing: 'Updating',
        historyPeriod: 'Period',
        historyDuration: 'Duration',
        historyGroupRate: 'Group',
        historyUserRate: 'User',
        historyPeak: 'Peak',
        historyResolvedRate: 'Resolved',
        historyEffectiveRate: 'Effective',
        historyCarriedIn: 'carried in',
        historyCurrent: 'Current',
        historyLoadFailed: 'Unable to load rate history.',
        historyDurationLessMinute: '< 1 min',
        historyDurationMinutes: '{minutes} min',
        historyDurationHoursMinutes: '{hours}h {minutes}m',
        historyDurationDaysHours: '{days}d {hours}h',
        historyPeakDisabled: 'Disabled'
      },
