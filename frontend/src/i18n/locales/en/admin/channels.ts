export default {
    ...
    channels: {
      ...
      emptyModelsInPricing: 'Add at least one model to each {platform} pricing rule',
    ...
    riskControl: {
      ...
      additionalEndpoints: 'Additional moderation endpoints',
      additionalEndpointsHint: 'Configure keys for each Base URL as a separate endpoint. All enabled endpoints share scheduling and failover.',
      addEndpoint: 'Add endpoint',
      newEndpoint: 'New moderation endpoint',
      endpointName: 'Endpoint name',
      endpointNamePlaceholder: 'For example: Backup OpenAI',
      endpointApiKeys: 'API keys for this endpoint',
      endpointApiKeysPlaceholder: 'One key per line; leave empty to retain saved keys',
      endpointApiKeysHint: 'New keys are appended to this endpoint. Saved keys are never returned to the browser.',
      endpointFieldsRequired: 'Complete the name, Base URL, and model for every moderation endpoint.',
      moderationKeyTargets: 'Moderation keys',
      moderationKeyTargetsHint: 'Each key has its own Base URL, model, and proxy. A successful test is required before adding it.',
      addModerationKey: 'Add key',
      moderationApiKey: 'OpenAI API Key',
      keyTestRequired: 'Complete all fields and test the connection before adding this key.',
      keyTestPassed: 'Test passed. This target can be added to the key list.',
      keyTestFailed: 'Moderation key test failed',
      testConnection: 'Test connection',
      addToKeyList: 'Add to key list',
      noModerationKeys: 'No moderation keys configured',
      pendingSave: 'Pending save',
      savedKey: 'Saved',
      editModerationKey: 'Edit saved key',
      editKeyTestRequired: 'Test the updated endpoint before applying these changes.',
      applyKeyChanges: 'Apply changes',
      directConnection: 'Direct connection',
      proxyID: 'Proxy #{id}',
      moderationEndpoint: 'Moderation endpoint',
      model: 'Model',
