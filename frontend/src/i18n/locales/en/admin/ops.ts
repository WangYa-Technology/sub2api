export default {
    ops: {
      ...
      servingNodeUnknown: 'Serving node unknown',
      metricsSource: 'Metrics snapshot source',
      metricsSourceUnknown: 'Snapshot source unknown',
      nodes: {
        title: 'Application nodes',
        onlineSummary: '{online} / {total} online',
        retentionHint: 'Nodes reported within the last 24 hours',
        node: 'Node / region',
        status: 'Status',
        dbPool: 'DB pool',
        ...
        unassignedRegion: 'Unassigned region',
        empty: 'Waiting for application nodes to report metrics'
      },
      systemLogs: {
        title: 'System Logs',
      ...
      settings: {
        ...
        accountErrorNotification: 'Account Status Alerts',
        accountErrorNotificationHint: 'Notify when an account enters an error or temporary-unschedulable state, including its name, type, and error details',
        proxyExpiryNotification: 'IP Expiry Reminders',
        proxyExpiryNotificationHint: 'Notify when an active IP enters its three-day expiry window, including its name, time remaining, and bound account count',
        wecom: {
          title: 'WeCom Group Bot',
          enabled: 'Enable WeCom bot notifications',
          enabledHint: 'WeCom and email are independent; rule alerts must also enable WeCom per rule',
          webhook: 'Bot Webhook',
          webhookPlaceholder: 'Paste the WeCom group bot webhook',
          webhookHint: 'Only the official WeCom HTTPS endpoint is allowed; saved URLs are shown masked',
          minSeverity: 'Minimum Alert Severity',
          allSeverities: 'All severities',
          rateLimit: 'Hourly Send Limit (0 = unlimited)',
          accountError: 'Account Status Alerts',
          accountErrorHint: 'Send WeCom notifications for account errors and temporary unschedulable states',
          proxyExpiry: 'IP Expiry Reminders',
          proxyExpiryHint: 'Send a WeCom reminder within three days of IP expiry',
          includeResolved: 'Recovery Notifications',
          includeResolvedHint: 'Send a WeCom message when a rule alert recovers',
          test: 'Send Test Message',
          testing: 'Testing...',
          testSuccess: 'WeCom bot test message sent',
          testFailed: 'Failed to send WeCom bot test message',
          webhookRequired: 'A webhook is required when WeCom bot notifications are enabled',
      ...
      tooltips: {
        ...
        db: 'Database connection pool status, including active and idle connections plus cumulative waits since instance startup.',
