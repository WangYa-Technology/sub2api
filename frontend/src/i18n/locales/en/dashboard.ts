export default {
  ...
  modelPlaza: {
    ...
    table: {
      ...
      paidPriceHelpLabel: 'View your price details',
      paidPriceHelp: 'The final price charged for model usage. It includes the channel price, the effective rate (group or user-specific), and the recharge conversion rate. Token models are priced per 1 million tokens; per-request and image models use their respective units.',
      officialPrice: 'Official Price',
      officialPriceHelpLabel: 'View official price details',
      officialPriceHelp: "The model provider's published reference price in USD. It is not multiplied by this site's effective rate or recharge conversion rate. This price is for comparison only and is not the amount charged by this site.",
      rate: 'Approx. Rate',
      rateHelpLabel: 'View approximate rate details',
      rateHelp: 'Output prices only: approximate rate = (your output price in CNY ÷ 6.8) ÷ official output price in USD. ≈ 0.04x means your output price is about 4% of the official price. This rate is for reference; actual charges follow Your Price.',
      paidUnitPerMillion: '¥ / 1M tokens',
