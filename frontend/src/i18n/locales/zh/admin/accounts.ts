export default {
    accounts: {
      ...
      upstreamBilling: {
        ...
        unlimited: '无限额',
        quotaFailed: '失败',
        quotaQueryFailed: '查询上游额度失败',
        quotaError: '最近一次额度查询失败：{message}',
        quotaValueDetails: '额度详情：{value}',
        noQuotaData: '无额度数据',
        quotaProvider: '提供方：{value}',
        quotaMode: '模式：{value}',
        quotaModeBalance: '余额',
        quotaModeQuota: '额度',
        quotaModeSubscription: '订阅',
        quotaModeRateLimits: '速率限制',
        quotaPlan: '套餐：{value}',
        ...
        quotaUnit: '单位：{value}',
        unknownUnit: '未知',
        quotaExpiresAt: '到期时间：{value}',
        quotaWindows: '额度窗口',
        quotaWindow: '{name}：已用 {used}，上限 {limit}，剩余 {remaining}，重置 {reset}',
        quotaObservedAt: '观测时间：{value}',
        stale: '已过期',
        unsupportedNotFound: '未找到费率接口（404）。',
        unsupportedMethod: '费率接口不支持当前请求方法（405）。',
        unsupportedGeneric: '未找到兼容的费率接口。',
        probeAuthFailed: '鉴权失败（{status}）。',
        probeRateLimited: '请求被限流（429）。',
        probeServerError: '上游服务错误（{status}）。',
        probeInvalidResponse: '费率响应格式错误。',
        probeResponseTooLarge: '费率响应过大。',
        probeResponseReadFailed: '读取费率响应失败。',
        probeEmptyResponse: '未返回费率响应。',
        probeMissingApiKey: '缺少 API Key。',
        probeInvalidBaseUrl: 'Base URL 无效。',
        probeProxyUnavailable: '代理不可用。',
        probeTransportUnavailable: '探测传输不可用。',
        probeRequestBuildFailed: '无法构造探测请求。',
        probeRequestFailed: '连接费率接口失败。',
        probeHttpError: 'HTTP {status}。',
        probeFailedReason: '费率探测失败。',
        probeErrorTitle: '发生错误：',
        probeErrorDetail: '{time} 探测时发生错误，{reason}',
        unsupported: '不支持',
        failed: '失败',
        notProbed: '未探测',
        ...
        minutesAgo: '{count} 分钟',
        hoursAgo: '{count} 小时',
        hoursMinutesAgo: '{hours} 小时 {minutes} 分钟',
        daysAgo: '{count} 天',
        staleCacheNotice: '当前页面显示的是 {age} 前的探测结果，请刷新页面查看后台最新数据。',
        staleProbeOverdueNotice: '当前显示的是 {age}前的上次成功倍率。自动探测已逾期，请先刷新页面；若仍未更新，请点击右侧刷新按钮重新探测。',
        manualProbeNotice: '当前显示的是 {age}前的上次成功倍率，请点击右侧刷新按钮重新探测。',
        failedNoRateNotice: '当前没有可显示的倍率，请点击右侧刷新按钮重试。',
        ...
        batchStarted: '已选择 {count} 个账号，将自动分为 {total} 批；正在探测第 1/{total} 批',
        batchProgress: '已完成第 {completed}/{total} 批；正在探测第 {next}/{total} 批',
        batchLimit: '每次最多探测 20 个账号',
        batchCompleted: '已完成 {count} 个账号的倍率探测',
        batchPartial: '倍率探测部分完成：成功 {success} 个，失败 {failed} 个',
        quotaBatchStarted: '已选择 {count} 个账号，将自动分为 {total} 批；正在获取第 1/{total} 批余额',
        quotaBatchProgress: '已完成第 {completed}/{total} 批；正在获取第 {next}/{total} 批余额',
        quotaBatchCompleted: '已完成 {count} 个账号的余额获取',
        quotaBatchPartial: '余额获取部分完成：成功 {success} 个，失败 {failed} 个',
        historyTitle: '声明倍率历史',
        historyRange: '历史范围',
        historyRangeDays: '{count} 天',
        historyRetry: '重试',
        historyTruncated: '仅显示最近 500 次检测到的变化。',
        historyEmpty: '此时间范围内没有检测到倍率变化。',
        historyRefreshing: '更新中',
        historyPeriod: '起止时间',
        historyDuration: '持续时间',
        historyGroupRate: '分组倍率',
        historyUserRate: '用户倍率',
        historyPeak: '高峰配置',
        historyResolvedRate: '解析倍率',
        historyEffectiveRate: '生效倍率',
        historyCarriedIn: '延续',
        historyCurrent: '当前',
        historyLoadFailed: '无法加载倍率历史。',
        historyDurationLessMinute: '< 1 分钟',
        historyDurationMinutes: '{minutes} 分钟',
        historyDurationHoursMinutes: '{hours} 小时 {minutes} 分钟',
        historyDurationDaysHours: '{days} 天 {hours} 小时',
        historyPeakDisabled: '未启用'
      },
