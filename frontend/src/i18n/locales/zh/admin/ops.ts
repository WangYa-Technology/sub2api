export default {
    ops: {
      ...
      servingNode: '当前服务节点',
      servingNodeUnknown: '服务节点未知',
      metricsSource: '指标快照来源',
      metricsSourceUnknown: '快照来源未知',
      nodes: {
        title: '应用节点',
        onlineSummary: '{online} / {total} 在线',
        retentionHint: '显示最近 24 小时内上报的节点',
        node: '节点 / 区域',
        status: '状态',
        dbPool: '数据库连接池',
        redisPool: 'Redis 连接池',
      ...
      settings: {
        ...
        minSeverity: '最低级别',
        accountErrorNotification: '账号异常通知',
        accountErrorNotificationHint: '账号进入错误或临时不可调度状态时通知，包含账号名称、类型和错误信息',
        proxyExpiryNotification: 'IP 到期提醒',
        proxyExpiryNotificationHint: '活跃 IP 进入到期前 3 天窗口时通知，包含 IP 名称、剩余时间和绑定账号数',
        wecom: {
          title: '企业微信群机器人',
          enabled: '启用企微机器人通知',
          enabledHint: '企微与邮件互相独立；告警规则还需逐条勾选企微通知',
          webhook: '机器人 Webhook',
          webhookPlaceholder: '粘贴企业微信群机器人 Webhook',
          webhookHint: '仅允许企业微信官方 HTTPS 地址，保存后只显示脱敏地址',
          minSeverity: '最低告警级别',
          allSeverities: '全部级别',
          rateLimit: '每小时发送上限（0 表示不限）',
          accountError: '账号异常通知',
          accountErrorHint: '账号错误或临时不可调度时发送企微通知',
          proxyExpiry: 'IP 到期提醒',
          proxyExpiryHint: 'IP 到期前 3 天内发送企微提醒',
          includeResolved: '恢复通知',
          includeResolvedHint: '规则告警恢复时发送企微消息',
          test: '发送测试消息',
          testing: '正在测试...',
          testSuccess: '企微机器人测试消息发送成功',
          testFailed: '企微机器人测试消息发送失败',
          webhookRequired: '启用企微机器人通知时必须配置 Webhook',
      ...
      tooltips: {
        ...
        db: '数据库连接池状态，包括活跃连接、空闲连接和实例启动后的累计等待次数。',
